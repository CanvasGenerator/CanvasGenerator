...
const { injecterEnv } = require('./socle-env');
...
function lire(fichier) {
    /* Les jetons %%ENV:...%% du socle prennent leur valeur ICI, a la publication.
       Voir lib/socle-env.js — drapeaux seulement, jamais de secret. */
    return injecterEnv(fs.readFileSync(path.join(SOCLE_DIR, fichier), 'utf8'));
}
