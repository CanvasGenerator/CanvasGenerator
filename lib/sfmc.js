 ...
 * Shared by the /api/sfmc/upload-image endpoint (server.js and api/router.js).
 */
async function uploadImageFromDataUrl({ name, schoolId, dataUrl }) {
    ...
    return uploadImageToSfmc({ name, base64, extension, schoolId });
}
