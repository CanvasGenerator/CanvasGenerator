...
export default function(editor, categories) {
  ...
  .pourquoi-grille{display:grid;grid-template-columns:1fr 1.2fr;align-items:stretch;font-family:'Montserrat',Arial,Helvetica,sans-serif;color:#1a1a1a;line-height:1.5;}
