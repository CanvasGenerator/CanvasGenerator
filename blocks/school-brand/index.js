...
<style>
  .footer-${s.id} {
    ...
    padding: 48px 24px 32px; font-family: ${fontStack}; border-top: 1px solid #ececec;
  }
  ...
  .footer-${s.id} .ftr-logo { font-size: 38px; font-weight: 800; letter-spacing: 2px; line-height: 1; color: #111111; margin-bottom: 10px; }
  .footer-${s.id} .ftr-baseline { font-size: 12px; font-weight: 600; line-height: 1.3; color: #555555; }
  .footer-${s.id} .ftr-socials { display: flex; gap: 12px; flex-wrap: wrap; }
  .footer-${s.id} .ftr-${s.id}-soc { width: 38px; height: 38px; display: flex; align-items: center; justify-content: center; background: #f5f5f5; border-radius: 50%; color: #111111; }
  ...
  .footer-${s.id} .ftr-link { color: var(--brand-primary, ${s.bg}); text-decoration: underline; }
  @media (max-width: 768px) {
