...
export default function(editor, categories) {
    ...
    const schools = [
        { catKey: 'CREAD', schoolId: 'cread', A: 'assets/cread', variants: [
        ...
        { catKey: 'EFJ', schoolId: 'efj', A: 'assets/efj', variants: [
        ...
        { catKey: 'ICART', schoolId: 'icart', A: 'assets/icart', variants: [
        ...
        { catKey: 'IFA', schoolId: 'ifa-paris', A: 'assets/ifa', variants: [
        ...
        { catKey: 'MOPA', schoolId: 'mopa', A: 'assets/mopa', variants: [
        ...
        { catKey: 'BLEUE', schoolId: 'ecole-bleue', A: 'assets/ecole-bleue', variants: [
        ...
        { catKey: 'ESEC', schoolId: 'esec', A: 'assets/esec', variants: [
        ...
        school.variants.forEach(v => {
            editor.BlockManager.add(v.id, {
                ...
                content: `
                    <header class="${v.id}">
                        <div class="hdr-inner">
                            <span class="hdr-logo"><img class="hdr-logo-img" src="${school.A}/${v.f}.png" alt="${school.catKey}"${logoLinkAttrs(school.schoolId)}></span>
