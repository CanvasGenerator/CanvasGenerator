const BLOCK_REGISTRY = [
    ...
    { id: 'header-icart', label: 'Header ICART', category: 'Navigation', scope: 'school', schools: ['icart'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'icart'], enabled: true },
    { id: 'footer-icart', label: 'Footer ICART', category: 'Navigation', scope: 'school', schools: ['icart'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'icart'], enabled: true },
    { id: 'header-cread', label: 'Header CREAD', category: 'Navigation', scope: 'school', schools: ['cread'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'cread'], enabled: true },
    { id: 'footer-cread', label: 'Footer CREAD', category: 'Navigation', scope: 'school', schools: ['cread'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'cread'], enabled: true },
    { id: 'header-esec', label: 'Header ÉSEC', category: 'Navigation', scope: 'school', schools: ['esec'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'esec'], enabled: true },
    { id: 'footer-esec', label: 'Footer ÉSEC', category: 'Navigation', scope: 'school', schools: ['esec'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'esec'], enabled: true },
    { id: 'header-ifa-paris', label: 'Header IFA PARIS', category: 'Navigation', scope: 'school', schools: ['ifa-paris'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'ifa-paris'], enabled: true },
    { id: 'footer-ifa-paris', label: 'Footer IFA PARIS', category: 'Navigation', scope: 'school', schools: ['ifa-paris'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'ifa-paris'], enabled: true },
    { id: 'header-mopa', label: 'Header MOPA', category: 'Navigation', scope: 'school', schools: ['mopa'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'mopa'], enabled: true },
    { id: 'footer-mopa', label: 'Footer MOPA', category: 'Navigation', scope: 'school', schools: ['mopa'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'mopa'], enabled: true },
    { id: 'header-ecole-bleue', label: 'Header ÉCOLE BLEUE', category: 'Navigation', scope: 'school', schools: ['ecole-bleue'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'ecole-bleue'], enabled: true },
    { id: 'footer-ecole-bleue', label: 'Footer ÉCOLE BLEUE', category: 'Navigation', scope: 'school', schools: ['ecole-bleue'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'ecole-bleue'], enabled: true },
    { id: 'header-efj', label: 'Header EFJ', category: 'Navigation', scope: 'school', schools: ['efj'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', 'efj'], enabled: true },
    { id: 'footer-efj', label: 'Footer EFJ', category: 'Navigation', scope: 'school', schools: ['efj'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', 'efj'], enabled: true },
    { id: 'header-3wa', label: 'Header 3W ACADEMY', category: 'Navigation', scope: 'school', schools: ['3wa'], thumbnail: 'assets/block-thumbnails/header-efap.svg', tags: ['header', '3wa'], enabled: true },
    { id: 'footer-3wa', label: 'Footer 3W ACADEMY', category: 'Navigation', scope: 'school', schools: ['3wa'], thumbnail: 'assets/block-thumbnails/footer-efap.svg', tags: ['footer', '3wa'], enabled: true },
