...
.imf-card { width: 100%; max-width: 520px; border-radius: 4px; background: #fff; padding: 24px 24px 28px; }
.imf-title { font-size: 18px; font-weight: 700; color: #111; margin: 0 0 4px; }
.imf-subtitle { font-size: 12px; color: #666; margin: 0 0 18px; }
.imf-row { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; margin-bottom: 10px; }
.imf-field { display: flex; flex-direction: column; margin-bottom: 10px; }
.imf-row .imf-field { margin-bottom: 0; }
.imf-field.hidden { display: none; }
.imf-label { font-size: 12px; color: #333; margin-bottom: 3px; display: block; }
.imf-label .req { color: #c00; }
...
.imf-input:focus, .imf-select:focus { border-color: #888; }
.imf-input.err, .imf-select.err { border-color: #c00; }
.imf-err-msg { font-size: 10px; color: #c00; margin-top: 2px; display: none; }
...
.imf-phone-wrap { display: flex; gap: 6px; }
.imf-phone-prefix {
...
.imf-rgpd { display: flex; align-items: flex-start; gap: 8px; margin: 10px 0 16px; }
.imf-rgpd input[type="checkbox"] { width: 14px; height: 14px; margin-top: 2px; flex-shrink: 0; cursor: pointer; accent-color: #333; }
.imf-rgpd-label { font-size: 11px; color: #333; line-height: 1.5; cursor: pointer; }
.imf-rgpd-label a { color: #333; text-decoration: underline; }
.imf-submit-wrap { display: flex; justify-content: center; }
.imf-submit {
...
.imf-submit:hover { background: #333; }
...
@media(max-width:460px){ .imf-row { grid-template-columns: 1fr; } .imf-phone-prefix { width: 60px; } }
</style>
