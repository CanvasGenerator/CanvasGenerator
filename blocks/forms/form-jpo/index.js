/**
 * Bloc : Formulaire Inscription JPO
 * ───────────────────────────────────────────────────────────────
 * MODE TEST : soumission gérée en JS pur.
 *
 * Architecture : PAS de <script> inline dans le HTML.
 * La logique interactive est initialisée via editor.on('component:mount')
 * depuis ce module, en accédant directement aux éléments du canvas iframe.
 * C'est la seule approche fiable avec GrapesJS chargé via CDN.
 */
...
<div class="jpo-card">
    ...
    /* ── Enregistrement des 6 variantes (3 FR + 3 EN) ───────────────── */
